...
public class UsuarioController {
	...
	public UsuarioController() {
		...
		encryptController = new EncryptController("SomosProgramadores"); 
	}
	...
	public Usuario validarLogin(int dni, String clave) {
	    ...
	    for (Usuario usuario : listaUsuarios) {
	        ...
	        // Intenta la comparación con la versión encriptada
	        String claveEncriptada = encryptController.ecnode(clave);
	        if (usuario.getDni() == dni && usuario.getClave().equals(claveEncriptada) && usuario.getEstado()) {
	            return usuario;
	        }
	    }
	...
	public void agregarUsuario(Usuario usuario) {
		try {
			 String claveEncriptada = encryptController.ecnode(usuario.getClave());
